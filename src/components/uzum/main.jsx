                        ...
                        <div id="top-products" className="products_inner">
                            <div className="card">
                                <div className="products-img-div">
                                    <img id="products-img" className="products-img  rounded-top" src width={232} height={310} alt="products" />
                                </div>
                                ...
                                <ul className="card_list">
                                    <li className="card_item">
                                        <div className="item-div">
                                            <h3 id="products-title" className="card-item_title" />
                                        </div>
                                        <div className="item-div">
                                            ...
                                            <p id="products-rating" className="card-item_text" />
                                        </div>
                                        <div className="item-div">
                                            <div className="item-div_prices">
                                                <div>
                                                    <p className="prices_text">
                                                        <del id="products-price" className="prices-del" />
                                                        so'm
                                                    </p>
                                                    <p className="prices_text">
                                                        <ins id="products-price-2" className="prices-ins" />
                                                        so'm
                                                    </p>
                                                </div>
                                                <a href="#">
